!(function(t, e) {
	'object' == typeof exports && 'undefined' != typeof module
		? (module.exports = e())
		: 'function' == typeof define && define.amd ? define(e) : ((t = t || self).Sweetalert2 = e());
})(this, function() {
	'use strict';
	function r(t) {
		return (r =
	...
	function h(t, e) {
		...
		(n = '"'
			...
			.concat(e, '" instead.')), -1 === D.indexOf(n) && (D.push(n), R(n));
	}
	function g(t) {
	...
	function at(t, e) {
		...
		e.showConfirmButton ||
			e.showCancelButton ||
			G(n), q(n, e, 'actions'), vt(o, 'confirm', e), vt(i, 'cancel', e), e.buttonsStyling
			? (function(t, e, n) {
	...
	var ct,
		...
		ft = function(t) {
			...
			if (ot()) v('SweetAlert2 requires document to initialize');
				...
				g.appendChild(o), (r = t), (a = W()).setAttribute('role', r.toast ? 'alert' : 'dialog'), a.setAttribute(
					'aria-live',
					r.toast ? 'polite' : 'assertive'
				), r.toast || a.setAttribute('aria-modal', 'true'), (c = g), 'rtl' ===
					window.getComputedStyle(c).direction && st(z(), _.rtl), (s = k()), (u = lt(s, _.input)), (l = lt(
					s,
					_.file
				)), (d = s.querySelector('.'.concat(_.range, ' input'))), (p = s.querySelector(
					'.'.concat(_.range, ' output')
				)), (f = lt(s, _.select)), (m = s.querySelector('.'.concat(_.checkbox, ' input'))), (h = lt(
					s,
					_.textarea
				)), (u.oninput = it), (l.onchange = it), (f.onchange = it), (m.onchange = it), (h.oninput = it), (d.oninput = function(
					t
				) {
	...
	function vt(t, e, n) {
		...
		tt(
			...
			'inline-block'
		), (t.innerHTML = n[''.concat(e, 'ButtonText')]), t.setAttribute('aria-label', n[''.concat(e, 'ButtonAriaLabel')]), (t.className = _[e]), q(t, n, ''.concat(e, 'Button')), st(t, n[''.concat(e, 'ButtonClass')]);
	}
	function bt(t, e) {
		var n = z();
		if (n) {
			...
			(o = n), 'string' == typeof (i = e.backdrop)
				...
				: i || st([document.documentElement, document.body], _['no-backdrop']), !e.backdrop &&
				e.allowOutsideClick &&
				R('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), (r = n), (a =
				e.position) in _
				? st(r, _[a])
				: (R('The "position" parameter is not valid, defaulting to "center"'), st(r, _.center)), (function(
				t,
				e
			) {
	...
	(Bt.text = Bt.email = Bt.password = Bt.number = Bt.tel = Bt.url = function(t, e) {
		...
		var n = Z(k(), 'checkbox');
		return (n.value = 1), (n.id = _.checkbox), (n.checked = Boolean(e.inputValue)), (t.querySelector(
			'span'
		).innerHTML =
			e.inputPlaceholder), t;
	...
	function Tt(t, e) {
		...
		e.html
			...
			: e.text
				...
				: G(
						c
					), (n = t), (o = e), (i = k()), (r = wt.innerParams.get(n)), (a = !r || o.input !== r.input), Ct.forEach(
			function(t) {
				var e = _[t],
					n = lt(i, e);
	...
	function Lt(t, e) {
		...
		q(a, e, 'header'), St(0, e), (function(t, e) {
			...
			X(
				e
			), e.setAttribute('src', t.imageUrl), e.setAttribute('alt', t.imageAlt), J(e, 'width', t.imageWidth), J(e, 'height', t.imageHeight), (e.className = _.image), q(e, t, 'image');
		})(
			e
		), (n = e), (o = C()), tt(o, n.title || n.titleText), n.title && rt(n.title, o), n.titleText && (o.innerText = n.titleText), q(o, n, 'title'), (i = e), ((r = M()).innerHTML = i.closeButtonHtml), q(r, i, 'closeButton'), tt(r, i.showCloseButton), r.setAttribute('aria-label', i.closeButtonAriaLabel);
	}
	function Ot(t, e) {
		var n, o, i, r;
	...
	var Ht = function() {
		...
		Vt = [],
		Rt = function(t, e) {
			(t.className = ''.concat(_.popup, ' ').concat(dt(t) ? e.showClass.popup : '')), e.toast
				? (st([document.documentElement, document.body], _['toast-shown']), st(t, _.toast))
				: st(t, _.modal), q(t, e, 'popup'), 'string' == typeof e.customClass && st(t, e.customClass), e.icon &&
				st(t, _['icon-'.concat(e.icon)]);
		};
	function Dt() {
		var t = W();
		t || Xe.fire(), (t = W());
		...
		X(
			e
		), X(n, 'inline-block'), st([t, e], _.loading), (n.disabled = !0), t.setAttribute('data-loading', !0), t.setAttribute('aria-busy', !0), t.focus();
	}
	function Nt() {
		return new Promise(function(t) {
			...
			(Wt.restoreFocusTimeout = setTimeout(function() {
				Wt.previousActiveElement && Wt.previousActiveElement.focus
					? (Wt.previousActiveElement.focus(), (Wt.previousActiveElement = null))
	...
	function Jt() {
		...
		if (t) {
			...
			t.showConfirmButton || (G(e.confirmButton), t.showCancelButton || G(e.actions)), ut(
				[e.popup, e.actions],
				_.loading
			), e.popup.removeAttribute('aria-busy'), e.popup.removeAttribute(
				'data-loading'
	...
	function oe(t, e, n, o) {
		n
			...
			: (
				...
				), e.parentNode && !document.body.getAttribute('data-swal2-queue-step') && e.parentNode.removeChild(e), I() &&
			(
				null !== Y.previousBodyPadding &&
					(
				...
				'undefined' != typeof window && Gt() && window.removeEventListener('resize', te),
	...
	function de(t) {
		...
		(e = t).inputValidator ||
			...
			), (t.animation = N(t.animation)), ((n = t).target && ('string' != typeof n.target || document.querySelector(n.target)) && ('string' == typeof n.target || n.target.appendChild)) || (R('Target parameter is not valid, defaulting to "body"'), (n.target = 'body')), 'string' == typeof t.title && (t.title = t.title.split('\n').join('<br />')), ft(t);
	}
	function pe(t) {
		var e = z(),
			n = W();
		'function' == typeof t.onBeforeOpen &&
			t.onBeforeOpen(
				n
			), xe(e, n, t), Ce(e, n), I() && ke(e, t.scrollbarPadding), K() || Wt.previousActiveElement || (Wt.previousActiveElement = document.activeElement), 'function' ==
			typeof t.onOpen &&
			setTimeout(function() {
				return t.onOpen(n);
	...
	function me(t, e) {
		'select' === e.input || 'radio' === e.input
			? Te(t, e)
			: -1 !== ['text', 'email', 'number', 'tel', 'textarea'].indexOf(e.input) && g(e.inputValue) && Ee(t, e);
	}
	function he(t, e) {
	...
	var Ce = function(t, e) {
		...
		ke = function(t, e) {
			...
			})(), 'undefined' != typeof window && Gt() && (te(), window.addEventListener('resize', te)), m(
		...
		xe = function(t, e, n) {
			st(t, n.showClass.backdrop), X(e), st(e, n.showClass.popup), st(
				[document.documentElement, document.body],
				_.shown
			), n.heightAuto &&
				n.backdrop &&
		...
		Se = {
			...
			radio: function(t, e, a) {
				...
				e.forEach(function(t) {
					...
					(o.type =
						'radio'), (o.name = _.radio), (o.value = e), a.inputValue.toString() === e.toString() && (o.checked = !0);
		...
		je = function(t, e, n) {
			...
			o.stopKeydownPropagation && e.stopPropagation(), 'Enter' === e.key
				...
				: 'Tab' === e.key
					? Ve(e, o)
					: -1 !== He.indexOf(e.key) ? Re() : -1 !== Ie.indexOf(e.key) && De(e, o, n);
		},
		qe = function(t, e, n) {
			...
			if (!e.toast)
				return N(e.allowEnterKey)
					? e.focusCancel && dt(t.cancelButton)
						...
						: e.focusConfirm && dt(t.confirmButton) ? t.confirmButton.focus() : void ye(0, -1, 1)
					: Ye();
		},
		Ye = function() {
	...
	var Ze,
		...
		$e = Object.freeze({
			...
			showValidationMessage: function(t) {
				...
				)), (e.validationMessage.style.marginRight = '-'.concat(n.getPropertyValue('padding-right'))), X(
					e.validationMessage
				);
				var o = this.getInput();
				o &&
				...
				!(function(t) {
					for (var e in t)
						Ft((i = e)) || R('Unknown parameter "'.concat(i, '"')), t.toast &&
							(
								(o = e),
								-1 !== Qt.indexOf(o) && R('The parameter "'.concat(o, '" is incompatible with toasts'))
							), zt((n = e)) && h(n, zt(n));
					var n, o, i;
				...
				e &&
					(
						t.popup &&
							...
							(Wt.swalCloseEventFinishedCallback(), delete Wt.swalCloseEventFinishedCallback),
						Wt.deferDisposalTimer && (clearTimeout(Wt.deferDisposalTimer), delete Wt.deferDisposalTimer),
